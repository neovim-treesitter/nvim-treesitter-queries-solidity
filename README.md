# nvim-treesitter-queries-solidity

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-solidity/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-solidity/actions/workflows/validate.yml)

Neovim tree-sitter queries for **solidity**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-solidity",
...
- [ ] Changes are scoped to `solidity` — do not include files for other languages
